          ...
          <div className="flex items-center gap-3 mb-2 animate-fade-in-up">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-extrabold tracking-tight">
                <span className="text-gradient-primary">投资分析</span>
              </h1>
              <p className="text-sm text-neutral-400">深度分析您的投资组合表现和风险</p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-arena-surface/50 rounded-xl p-4">
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-400 mt-1">加密货币 ↔ 黄金</div>
                <div className="text-xs text-neutral-400 mt-1">
            ...
            <div className="bg-arena-surface/50 rounded-xl p-4">
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-400 mt-1">股票 ↔ 黄金</div>
                <div className="text-xs text-neutral-400 mt-1">
      ...
      <section className="relative max-w-[1400px] mx-auto px-6 pb-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-neutral-50">风险指标</h3>
          </div>
          ...
          {riskMetrics ? (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-neutral-400">年化收益率</div>
                ...
                <div>
                  <div className="text-sm text-neutral-400">年化波动率</div>
